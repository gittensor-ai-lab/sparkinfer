...
|---:|---:|---:|---:|---:|
| 16k | **128.7** tok/s | 87.0 tok/s | **1.480×** | 1.730 |
...
<sub>Auto-refreshed by the DSpark eval bot at `b8673f8d4` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
