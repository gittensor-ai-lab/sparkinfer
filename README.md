...
|---:|---:|---:|---:|---:|
| 16k | **99.9** tok/s | 86.9 tok/s | **1.150×** | 1.407 |
...
<sub>Auto-refreshed by the DSpark eval bot at `d8e175fe7` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
