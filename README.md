...
|---:|---:|---:|---:|---:|
| 16k | **100.1** tok/s | 86.9 tok/s | **1.153×** | 1.438 |
...
<sub>Auto-refreshed by the DSpark eval bot at `b0e59b593` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
