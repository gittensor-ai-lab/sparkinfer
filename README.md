...
|---:|---:|---:|---:|---:|
| 16k | **125.6** tok/s | 86.5 tok/s | **1.451×** | 1.707 |
...
<sub>Auto-refreshed by the DSpark eval bot at `351de6b03` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
