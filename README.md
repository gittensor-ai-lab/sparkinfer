...
|---:|---:|---:|---:|---:|
| 16k | **128.7** tok/s | 86.9 tok/s | **1.482×** | 1.730 |
...
<sub>Auto-refreshed by the DSpark eval bot at `27580ba13` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
