...
|---:|---:|---:|---:|---:|
| 16k | **100.6** tok/s | 86.8 tok/s | **1.158×** | 1.407 |
...
<sub>Auto-refreshed by the DSpark eval bot at `6dbe47f36` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
