...
|---:|---:|---:|---:|---:|
| 16k | **100.6** tok/s | 87.0 tok/s | **1.157×** | 1.407 |
...
<sub>Auto-refreshed by the DSpark eval bot at `c046a2d4c` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
