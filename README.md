...
|---:|---:|---:|---:|---:|
| 16k | **128.9** tok/s | 86.9 tok/s | **1.483×** | 1.730 |
...
<sub>Auto-refreshed by the DSpark eval bot at `82199fdab` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
