...
|---:|---:|---:|---:|---:|
| 16k | **130.3** tok/s | 88.4 tok/s | **1.474×** | 1.730 |
...
<sub>Auto-refreshed by the DSpark eval bot at `394a1af37` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
