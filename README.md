...
|---:|---:|---:|---:|---:|
| 16k | **125.5** tok/s | 86.9 tok/s | **1.444×** | 1.707 |
...
<sub>Auto-refreshed by the DSpark eval bot at `5b0b7c701` — these are the numbers that PR measured on the pinned RTX 5090, which after squash-merge are main's. Regenerated on every auto-merge, so the table cannot drift behind the code.</sub>
